...
Partial Class Introtext
    ...
    Private Sub InitializeComponent()
        ...
        Me.worddimmer = New System.Windows.Forms.Timer(Me.components)
        Me.wordlighter = New System.Windows.Forms.Timer(Me.components)
        Me.SuspendLayout()
        '
        'Label1
        '
        ...
        'worddimmer
        '
        Me.worddimmer.Interval = 1
        '
        'wordlighter
        '
        Me.wordlighter.Interval = 1
        '
        'Introtext
        '
    ...
    Friend WithEvents worddimmer As Timer
    Friend WithEvents wordlighter As Timer
End Class
